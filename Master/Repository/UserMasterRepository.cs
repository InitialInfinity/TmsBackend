...
namespace Master.Repository
{
    public class UserMasterRepository:IUserMasterRepository
    {
		...
		public async Task<IActionResult> GetEmailId(EmailConfigure model)
		{
			using (var connection = _context.CreateConnection())
			{
				//Guid? userIdValue = (Guid)user.UserId;
		...
		public DynamicParameters SetParameter(UserMaster user)
        {
            ...
            parameters.Add("@um_staffdesid", user.um_staffdesid, DbType.String); 
            parameters.Add("@um_fullname", user.um_fullname, DbType.String); 
            parameters.Add("@um_staffdepid", user.um_staffdepid, DbType.String); 
