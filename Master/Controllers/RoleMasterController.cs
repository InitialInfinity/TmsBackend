...
namespace Master.Controllers
{
    ...
    public class RoleMasterController : ControllerBase
    {
        ...
        [HttpGet("GetAll")]
        public async Task<IActionResult> GetRole(string? UserId, string status)
        {
            try
            {
        ...
        [HttpGet("GetRoleById")]
        public async Task<IActionResult> GetCountry(string UserId, Guid? r_id)
        {
            try
            {
                RoleMaster user = new RoleMaster();
        ...
        [HttpGet("GetExcel")]
        public async Task<IActionResult> GetExcel(string UserId, string status)
        {
            try
            {
                RoleMaster user = new RoleMaster();
        ...
        [HttpGet("GetPdf")]
        public async Task<IActionResult> GetPdf(string? UserId, string status)
        {
            try
            {
                RoleMaster user = new RoleMaster();
